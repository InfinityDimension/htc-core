...
**Example**
    ...
    http://localhost:4000/api/accounts/open
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/accounts/getBalance?address=<address>
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/accounts/getPublicKey?address=<address>
...
**Example**
    ...
    curl -k -H "Content-Type: application/json" \
    -X POST -d '{"secret":"<INSERT SECRET HERE>"}' \
    http://localhost:4000/api/accounts/generatePublicKey
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/accounts?address=<address>
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/accounts/delegates?address=<address>
...
**Example - No Second Secret**
    ...
    http://localhost:4000/api/accounts/delegates
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/loader/status/
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/loader/status/sync
...
**Example - blockId**
    ...
    curl -k -X GET http://localhost:4000/api/transactions?blockId=<blockId>

**Example - senderId**

    curl -k -X GET http://localhost:4000/api/transactions?senderId=<senderId>

**Example - senderId**

    curl -k -X GET http://localhost:4000/api/transactions?recipientId=<recipientId>
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/transactions/get?id=<id>
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/transactions/unconfirmed/get?id=<id>
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/transactions/unconfirmed
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/peers
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/peers/get?ip=<ip>&port=<port>
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/peers/version
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/blocks/get?id=<id>
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/blocks?generatorPublicKey=<generatorPublicKey>
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/blocks/getFee
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/blocks/getFees
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/blocks/getReward
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/blocks/getSupply
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/blocks/getHeight
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/blocks/getStatus
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/blocks/getNethash
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/blocks/getMilestone
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/signatures/get?id=<id>
...
**Example**
    ...
    http://localhost:4000/api/signatures
...
**Example**
    ...
    http://localhost:4000/api/delegates
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/delegates?limit=<limit>
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/delegates/get?publicKey=publicKey
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/delegates/count
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/delegates/voters?publicKey=<publicKey>
...
**Example**
    ...
    curl -k -H "Content-Type: application/json" \
    -X POST -d '{"secret":"<INSERT SECRET HERE>"}' \
    http://localhost:4000/api/delegates/forging/enable
...
**Example**
    ...
    curl -k -H "Content-Type: application/json" \
    -X POST -d '{"secret":"<INSERT SECRET HERE>"}' \
    http://localhost:4000/api/delegates/forging/disable
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/delegates/forging/getForgedByAccount?generatorPublicKey=<generatorPublicKey>
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/dapps?name=<INSERT APPLICATION NAME HERE>
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/dapps/get?id=<id>
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/dapps/search?installed=1
...
**Example**
    ...
    http://localhost:4000/api/dapps/install
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/dapps/installed
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/dapps/installedIds
...
**Example**
    ...
    curl -k -H "Content-Type: application/json" \
    -X POST -d '{"id":"<INSERT ID HERE>"}' \
    http://localhost:4000/api/dapps/uninstall
...
**Example**
    ...
    curl -k -H "Content-Type: application/json" \
    -X POST -d '{"id":"<INSERT ID HERE>"}' \
    http://localhost:4000/api/dapps/launch
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/dapps/installing
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/dapps/uninstalling
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/dapps/launched
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/dapps/categories
...
**Example**
    ...
    curl -k -H "Content-Type: application/json" \
    -X POST -d '{"id":"<INSERT ID HERE>"}' \
    http://localhost:4000/api/dapps/stop
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/multisignatures/pending?publicKey=<publicKey>
...
**Example**
    ...
    http://localhost:4000/api/multisignatures
...
**Example**
    ...
    http://localhost:4000/api/multisignatures/sign
...
**Example**
    ...
    curl -k -X GET http://localhost:4000/api/multisignatures/accounts?publicKey=<publicKey>
